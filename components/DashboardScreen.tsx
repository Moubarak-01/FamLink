...
const ParentBookingCard: React.FC<{ request: EnrichedBookingRequest }> = ({ request }) => {
    ...
    if (request.status === 'accepted') statusColor = 'bg-green-500 dark:bg-green-600';
    if (request.status === 'declined') statusColor = 'bg-red-400 dark:bg-red-600';
    if (request.status === 'pending') statusColor = 'bg-yellow-400 dark:bg-yellow-600';
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-xl shadow-lg border border-[var(--border-color)] relative overflow-hidden">
            <div className="flex justify-center mb-3">
                {nannyPhoto ? (
                    ...
                    <div className="w-16 h-16 rounded-full bg-gray-500 flex items-center justify-center border-2 border-[var(--border-color)]">
