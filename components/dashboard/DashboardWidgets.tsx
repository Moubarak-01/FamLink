            ...
            <div className="flex-grow">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {onDelete && (
                            <button onClick={() => { if (window.confirm(t('confirm_delete_task'))) onDelete(task.id); }} className="text-gray-400 hover:text-red-500 transition-colors" title="Delete Task">
