...
const Header: React.FC<HeaderProps> = ({ isAuthenticated, user, onLogout, onEditProfile, onViewSubscription, onOpenSettings, notifications = [], onClearNotifications, onNotificationClick }) => {
    const { t } = useLanguage();
    ...
    return (
        <header
            className="w-full relative z-[1000] transition-colors duration-300"
        >
