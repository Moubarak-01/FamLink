      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-lg mx-auto">
        ...
        <div>
          ...
          <LocationInput
            ...
            className={getInputClass(typeof location === 'string' ? location : '')}
          />
        </div>
        <div>
          <PhoneInput
        ...
        <div>
          ...
          <input type="text" id="experience" value={experience} onChange={(e) => validateAndSet('experience', e.target.value)} placeholder={t('placeholder_experience_years')} required className={getInputClass(experience, errors.experience)} />
        ...
        <div>
          ...
          >
            {isSubmitting ? t('button_saving') : t('button_save_publish')}
          </button>
        </div>
      </form>
